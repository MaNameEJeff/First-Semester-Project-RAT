...
def main():  # Program execution begins from here.
    ...
    if first_puzzle:
        ...
        bg = PhotoImage(file="./Assets/intro.png")
    ...
    bg = PhotoImage(file="./Assets/user_entry.png")
    ...
    bg2 = PhotoImage(file="./Assets/maze_ui.png")
    ...
    img = Image.open("./Assets/arrowkeys.png")
    ...
    def user_solved():  # When user manages to solve the maze
        ...
        Label(maze_UI, text="🎉 Congratulations 🎉", font=(r"HK Grotesk", 40), fg="#000000", bg="#ffffff").place(anchor='e', x=(1720/1920)*width-(width/19), y=(375/1080)*height)
